/**
 * Main Application
 * Initializes and coordinates all components for the Plant Etymology Database
 */
...
class PlantEtymologyApp {
    ...
    async init() {
        ...
        try {
            ...
            console.log('Plant Etymology Database initialized successfully');
        } catch (error) {
    ...
    initializeComponents() {
        ...
        this.searchManager = new PlantEtymologySearchManager();
     ...
     * @returns {PlantEtymologySearchManager|null} Search manager instance
     */
    getSearchManager() {
...
window.PlantEtymologyApp = PlantEtymologyApp;
